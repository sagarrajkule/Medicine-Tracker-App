...
#     name: str
#     category: str  # supplement, antibiotic, etc.
#     type: str  # tablet, syrup, cream
#     tags: str  # comma-separated tags
#     purpose: str
#     dosage: str  # e.g., "1 tablet daily after lunch"
#     duration_days: Optional[int] = None
#     start_date: Optional[str] = None  # ISO format date
#     end_date: Optional[str] = None  # ISO format date (auto-calculated or manual)
...
#         logger.warning(
#             "Using MOCK Google Drive service. "
#             "Place 'client_secrets.json' in /app/backend/ and set GOOGLE_DRIVE_ENABLED=true in .env to enable real uploads."
#         )
...
#         # Auto-calculate end_date if not provided but duration is
#         if medicine_dict.get('start_date') and medicine_dict.get('duration_days'):
#             if not medicine_dict.get('end_date'):
#                 medicine_dict['end_date'] = calculate_end_date(
#                     medicine_dict['start_date'],
#                     medicine_dict['duration_days']
#                 )
...
#         # Auto-calculate end_date if needed
#         if medicine_dict.get('start_date') and medicine_dict.get('duration_days'):
#             if not medicine_dict.get('end_date'):
#                 medicine_dict['end_date'] = calculate_end_date(
#                     medicine_dict['start_date'],
...
#     """Upload prescription file to Google Drive (mock for now)."""
#     try:
#         # Validate file type
...
#         file_id, shareable_link = await drive_service.upload_file(
